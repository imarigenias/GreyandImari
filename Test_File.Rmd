...
```{r}
  ...
  print("Select column by number --> df[, num_col]")
  patients[, 1]
  
  print('Select specific row --> df[num_row, ]')
  patients[1, ]
...
## Arsenal 
He also mentioned an R package named `aresnal`. I'm going to download it here. I am not sure what it does.
```{r arsenal,}
